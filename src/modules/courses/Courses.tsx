...
export default function Courses() {
  ...
  const filteredBatches = MOCK_BATCHES.filter(b => {
    const course = MOCK_COURSES.find(c => c.id === b.courseId);
    return (
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <TabsList className="h-9">
              <TabsTrigger value="courses" className="gap-2 text-xs py-1">
                <BookOpen className="w-3.5 h-3.5" />
                Courses
              </TabsTrigger>
              <TabsTrigger value="batches" className="gap-2 text-xs py-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
              <DialogTrigger render={<Button className="gap-2 shrink-0 h-9 text-xs font-bold" />}>
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={() => setIsAddOpen(false)}>Create {activeTab === 'courses' ? 'Course' : 'Batch'}</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          </div>
                ...
                <Card key={course.id} className="flex flex-col">
                  <CardHeader className="py-4 px-5">
                    <div className="flex justify-between items-start">
                      <Badge variant="secondary" className="mb-1 text-[10px] uppercase tracking-wider">{course.duration}</Badge>
                  ...
                  <CardContent className="flex-1 py-1 px-5">
                  ...
                  <CardFooter className="border-t py-3 px-5 flex justify-between items-center">
                    <span className="text-base font-black text-primary">₹{course.fees.toLocaleString()}</span>
